...
# TODO: add tests for the new games planner (using test cases from this file)
...
class TestGamesHistory(unittest.TestCase):
    ...
    def test_add_game_to_existing_team_should_have_two_game_dates(self):
        ...
        self.assertEqual(len(teams[home_team].games),
                         2, "Home team should have 2 game dates")
    ...
    #     games_history = GamesHistory()
    #     games_dictionary = self._construct_game_dictionary(
    #         "bos", "tor", datetime(2018, 10, 13))

    #     games = list()
    #     games.append(games_dictionary)
    #     teams = games_history.build_games_history(games)
